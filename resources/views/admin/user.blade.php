...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/css/Source%20Sans%20Pro.css?h=c428583e77f293ddfe0fb495baaca4ee')}}">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="{{asset('assets/css/Application-Form.css?h=fe95b47d2ee444a933e2d192ca0da83c')}}">
            ...
            <div id="layoutSidenav_nav">
                <div id="sidenavAccordion" class="sb-sidenav accordion sb-sidenav-dark">
                    ...
                    <div class="sb-sidenav-footer">
                        <div class="small"><span>{{ Session::get('username') }}</span></div>
                    </div>
                </div>
            </div>
            <div class="col-md-10" style="margin-bottom: 1000px;">
                <div class="card"><div class="card-body" style="padding-left: 25px;padding-top: 55px;margin-left: 0px;">
    <h2>Users</h2><span> @foreach($user as $u) @endforeach </span>
    <div>
