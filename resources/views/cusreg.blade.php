        ...
        <div class="container" style="padding-left: 0px;padding-right: 20px;">
            ...
            <div class="row d-flex justify-content-center">
                <div class="col">
                    ...
                    <form class="container" action="{{ url('store-customer') }}" method="POST">
                        {{ csrf_field() }}
                        ...
                        <div class="container">
                            <form id="application-form">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <p><strong>Password</strong><span class="text-danger">*</span></p><input class="form-control" type="password" required="" name="password" id="password" placeholder="a-Z, 1-9 , !@#$%^&amp;*()">
                                    <p><strong>Confirm Password</strong><span class="text-danger">*</span></p><input class="form-control" type="password" required="" name="password_confirm" id="password_confirm" placeholder="a-Z, 1-9 , !@#$%^&amp;*()">
                                </div>
