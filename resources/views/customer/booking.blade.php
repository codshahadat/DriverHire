...
<body>
    <div>
        ...
        <div id="layoutSidenav">
                        ...
                        <div class="nav">
                            ...
                            <div>
                                ...
                                <div class="sb-sidenav-menu-heading"><span>User Section</span></div><a class="nav-link active" href="{{ url('dashboard')}}">
                                    <div class="sb-nav-link-icon"><i class="fa fa-dashboard"></i></div><span>Return to main screen</span>
                                </a>
                            </div>
                            <div>
                            ...
                            <div><a class="nav-link collapsed" href="#" aria-expanded="false" aria-controls="collapse2" data-bs-toggle="collapse" data-bs-target="#collapse2">
                                    ...
                                    {{-- <div class="sb-nav-link-icon"><i class="fa fa-dashboard"></i></div><span>Booking</span>
                                    <div class="sb-sidenav-collapse-arrow"><i class="fa fa-angle-down"></i></div> --}}
                                </a>
            ...
            <h2>Bookings</h2><span> @foreach($book as $data) @endforeach </span>
                      ...
                      @foreach($book as $data)
                          <tr>
                              ...
                              <td><button id="sslczPayBtn"
                                ...
                                endpoint="/pay-via-ajax" style="width: 150px"> Pay Now
                        </button></td>
                              {{-- <td>
                                  <a href="{{ url('edit_data/'.$data->id) }}">Edit</a>
                              </td> --}}
                          </tr>
                      @endforeach
                  </tbody>
    ...
    <script src="{{ asset('assets/js/sand.js') }}"></script>
