...
<body>
    ...
    <img src="{{ asset('images/' . session('imagename')) }}" alt="{{ session('username') }}" width="500">
@else
    No picture
@endif
                                            ...
                                            <div class="col-lg-6 px-xl-10">
                                                ...
                                                <ul class="list-unstyled mb-1-9">
                                                    <li class="mb-2 mb-xl-3 display-28"><span class="display-26 text-secondary me-2 font-weight-600">Position:</span> {{ Session::get('userid')}}</li>
                                                    ...
                                                    <li class="display-28"><span class="display-26 text-secondary me-2 font-weight-600">Phone:</span> {{ Session::get('phone')}}</li>
                                                </ul>
