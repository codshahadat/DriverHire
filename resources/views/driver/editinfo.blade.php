...
<div class="container">
                        ...
                        @endif
                            <div class="container">
                                ...
                                <form id="application-form">
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="row">
                                            <div class="col" style="width: 538px;">
                                            ...
                                            <div class="col">
                                                <p style="margin-top: 0px"><strong>Driver Type</strong> &nbsp; <span class="text-danger">*</span></p>
                                                
                                                    <select id="drivertype" value="{{$user->drivertype}}" class="form-select" aria-label="Default select example" name="drivertype" style="padding-top: 6px;margin-top: 0px;padding-left: 16px;margin-left: 0px;padding-right: 0px;margin-right: 18px;">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <span id="password-strength" class="text-danger"></span>
                                    </div>
                                    <div class="form-group mb-3">
    ...
    <div class="file">
        <!-- Upload image input -->
        <div class="input-group mb-3 px-2 py-2 rounded-pill bg-white shadow-sm">
            <input id="image" name="image" type="file" value="{{ asset('images/' . $user->imagename) }}" required="" onchange="readURL(this);" class="form-control border-0">
        </div>
