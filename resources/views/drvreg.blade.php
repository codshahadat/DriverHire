    ...
    <section class="position-relative py-4 py-xl-5">
        ...
        <div class="container" style="padding-left: 0px;padding-right: 20px;">
            ...
            <div class="row d-flex justify-content-center">
                <div class="col">
                    <form class="container" onsubmit="return validatePassword();" action="{{ url('store-register') }}" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="container">
                            ...
                            <form id="application-form">
                                ...
                                <div class="form-group mb-3">
                                    <div class="row">
                                        <div class="col">
                                            <p><strong>Qualification</strong></p><input class="form-control" type="text" required="" name="qualification" id="qualification" placeholder="SSC HSC JSC">
                                        </div>
                                        <div class="col">
